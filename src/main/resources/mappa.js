(function webpackUniversalModuleDefinition(root, factory) {
  ...
  else if (typeof exports === 'object') exports['Mappa'] = factory();
  else root['Mappa'] = factory();
})(this, function () {
                ...
                value: function messages() {
                  return {
                    size: function size(s, m) {
                      console.warn(
                        'You requested an image with a ' +
                          s +
                          ' of ' +
                          m +
                          'px. Google Maps Static API max ' +
                          s +
                          ' value is 640px. For larger images, change the scale to 2 and keep the ' +
                          s +
                          ' between 1-640px. i.e: if you want an image 800x800px, set the width and height to 400x400 and the scale to 2.'
                      );
                    },
                    key: function key() {
                    ...
                    size: function size(s, m) {
                      console.warn(
                        'You requested an image with a ' +
                          ...
                          ' of ' +
                          m +
                          'px. Mapquest Static API max ' +
                          s +
                          ' value is 1920px. For larger images, change the scale to 2 and keep the ' +
                          s +
                          ' between 170x30px. i.e: if you want an 3840x3840px image, set the width and height to 1920x1920 and the scale to 2.'
                      );
                    },
                    key: function key() {
                ...
                value: function fromPointToLatLng() {
                  if (this.ready) {
                    ...
                    var point = new google.maps.Point(
                      (arguments.length <= 0 ? undefined : arguments[0]) / scale + bottomLeft.x,
                      (arguments.length <= 1 ? undefined : arguments[1]) / scale + topRight.y
                    );
